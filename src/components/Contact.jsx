...
export default function Contact({ t }) {
  ...
  const handleSubmit = () => {
    ...
    window.location.href = `mailto:ariancerna.dev@gmail.com?subject=${subject}&body=${body}`
  ...
  const contacts = [
    {
      ...
      label: 'ariancerna.dev@gmail.com', href: 'mailto:ariancerna.dev@gmail.com', bg: 'bg-purple/15', border: 'border-purple/30', hover: 'hover:text-cyan'
    },
    {
      icon: (
        <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor" aria-hidden="true">
      ...
      label: 'github.com/ariancerna', href: 'https://github.com/ariancerna', bg: 'bg-cyan/15', border: 'border-cyan/30', hover: 'hover:text-cyan'
    },
  ]
        ...
        <div className="lg:col-span-1">
          ...
          <div className="space-y-3">
            {contacts.map((contact, i) => (
              ...
              >
                <span className={`w-10 h-10 shrink-0 rounded-2xl ${contact.bg} border ${contact.border} grid place-items-center text-base font-bold`}>
                  {contact.icon}
                </span>
                {contact.label}
              </a>
